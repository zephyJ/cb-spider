...
func (vmHandler *AlibabaVMHandler) ResumeVM(vmID string) {
...
func (vmHandler *AlibabaVMHandler) SuspendVM(vmID string) {
	cblogger.Infof("vmID : [%s]", vmID)
...
func (vmHandler *AlibabaVMHandler) RebootVM(vmID string) {
	cblogger.Infof("vmID : [%s]", vmID)
...
func (vmHandler *AlibabaVMHandler) TerminateVM(vmID string) {
	cblogger.Infof("vmID : [%s]", vmID)
...
func (vmHandler *AlibabaVMHandler) GetVM(vmID string) irs.VMInfo {
	cblogger.Infof("vmID : [%s]", vmID)
...
func (vmHandler *AlibabaVMHandler) ListVM() []*irs.VMInfo {
...
func (vmHandler *AlibabaVMHandler) GetVMStatus(vmID string) irs.VMStatus {
	cblogger.Infof("vmID : [%s]", vmID)
...
func (vmHandler *AlibabaVMHandler) ListVMStatus() []*irs.VMStatusInfo {
	cblogger.Infof("Start")
